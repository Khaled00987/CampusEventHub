...
<form method="post" action="<?= url('/admin/announcements/' . $announcement['id'] . '/update') ?>" data-validate="announcement" novalidate>
    <?= CSRF::field() ?>
    <div class="dash-card dash-form-card">
        <div class="dash-form-body">
            <div class="dash-form-section">
                <h3>Announcement content</h3>
                <?php $item = $announcement; include APP_PATH . '/views/admin/announcements/_form.php'; ?>
            </div>
        </div>
